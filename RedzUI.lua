...
local redzlib = {
	Themes = {
		...
		BlackGrey = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 10, 11)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(16, 16, 17)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 10, 11))
			}),
			["Color Hub 2"] = Color3.fromRGB(14, 14, 15),
			["Color Stroke"] = Color3.fromRGB(35, 35, 37),
			["Color Theme"] = Color3.fromRGB(165, 165, 172),
			["Color Text"] = Color3.fromRGB(235, 235, 238),
			["Color Dark Text"] = Color3.fromRGB(145, 145, 150)
		}
	},
	Info = {
		Version = "1.1.0"
...
function redzlib:MakeWindow(Configs)
	...
	if IsMobile then
		UISizeX, UISizeY = 490, 320
	end
	redzlib.Save.UISize = {UISizeX, UISizeY}
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddDropdown(Configs)
			...
			local SelectedFrame = InsertTheme(Create("Frame", Button, {
				...
				AnchorPoint = Vector2.new(1, 0.5),
				BackgroundColor3 = Theme["Color Stroke"]
			}), "Stroke")Make("Corner", SelectedFrame, UDim.new(0, 8))
